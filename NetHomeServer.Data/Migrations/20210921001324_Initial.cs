        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Swing = table.Column<bool>(type: "INTEGER", nullable: true),
                    TimerSet = table.Column<bool>(type: "INTEGER", nullable: true),
                    TimerValue = table.Column<double>(type: "REAL", nullable: true),
                    IsOpen = table.Column<bool>(type: "INTEGER", nullable: true),
                    RGBLight_Ison = table.Column<bool>(type: "INTEGER", nullable: true),
                    Mode = table.Column<string>(type: "TEXT", nullable: true),
                    Brightness = table.Column<int>(type: "INTEGER", nullable: true),
                    Red = table.Column<int>(type: "INTEGER", nullable: true),
                    Green = table.Column<int>(type: "INTEGER", nullable: true),
                    Blue = table.Column<int>(type: "INTEGER", nullable: true),
                    White = table.Column<int>(type: "INTEGER", nullable: true),
                    Gain = table.Column<int>(type: "INTEGER", nullable: true),
                    Percentage = table.Column<int>(type: "INTEGER", nullable: true),
                    SmartSwitch_Ison = table.Column<bool>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeviceUser_Device_DevicesId",
